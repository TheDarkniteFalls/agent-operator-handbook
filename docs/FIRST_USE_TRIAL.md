...
The trial is especially useful for writers, researchers, creators, programme
leads, small-business owners, and other people who are comfortable directing
work in ordinary language but do not want to become software engineers first.
...
- Report only generalized, redacted, or synthetic details that are safe to
  publish permanently.
- Do not authorize sending, publishing, deleting, purchasing, deploying, or
  changing shared state merely to complete this trial.
...
- whether the result was used, edited, rejected, or abandoned;
- the first confusing term, hidden assumption, or unnecessary step;
